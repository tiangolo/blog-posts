...
This is taken from the [docs for FastAPI](https://fastapi.tiangolo.com/async/), a modern framework for building APIs in Python.
...
To see how to achieve this parallelism in production see the [FastAPI docs for Deployment](https://fastapi.tiangolo.com/deployment/).
...
This version has some of the details that are very specific to FastAPI trimmed out. If you want to learn those, including how to get asynchronous performance benefits while still writing standard `def` functions and using standard libraries, check the [FastAPI docs](ps://fastapi.tiangolo.com/async/).

If you want a deeper and much more technical explanation of all this, check this [video series from EdgeDB](https://www.youtube.com/watch?v=Xbl7XjFYsN4) by [Łukasz Langa](https://twitter.com/llanga).
